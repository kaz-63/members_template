! function(a) {
    ...
    return c.prototype.update = function() {
        ...
        this.g.beginPath(), this.g.fillStyle = this.particleColor, this.g.globalAlpha = .7, this.g.arc(this.x, this.y, 2.7, 0, 2 * Math.PI), this.g.fill()
    }, b = function(a, b) {
        ...
        this.options.interactive && (this.p = new c(this), this.p.velocity = {
            x: 0,
            y: 0
        }, this.o.push(this.p)), requestAnimationFrame(this.update.bind(this))
...
var options = {
    particleColor: '#888',
    background: 'layout/bg/img/building.jpg',
    interactive: true,
    speed: 'medium',
    density: 'high'
};
